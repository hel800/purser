...
LangString alreadyInstalledLong ${LANG_ENGLISH} "${PRODUCTNAME} ${VERSION} is already installed. Select the operation you want to perform and click Next to continue. Your todos and settings are kept either way — upgrading never touches the database."
...
LangString deleteAppData ${LANG_ENGLISH} "Delete the application data (your todos database and settings!)"
